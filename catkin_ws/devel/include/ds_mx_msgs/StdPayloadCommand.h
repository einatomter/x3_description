...
struct StdPayloadCommand_
{
  ...
  _stamp_type stamp;
   ...
   typedef std::vector< ::ds_core_msgs::KeyString_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::KeyString_<ContainerAllocator> >::other >  _config_type;
  _config_type config;
