...
struct MissionDisplay_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::ds_mx_msgs::MissionElementDisplay_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_mx_msgs::MissionElementDisplay_<ContainerAllocator> >::other >  _elements_type;
