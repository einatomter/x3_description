...
struct NorbitWC_
{
  ...
  _gate_tilt_type gate_tilt;
   ...
   typedef std::vector<uint32_t, typename ContainerAllocator::template rebind<uint32_t>::other >  _pixel_data_type;
  _pixel_data_type pixel_data;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _beam_dir_type;
