...
struct MultibeamRaw_
{
  ...
  _soundspeed_type soundspeed;
   ...
   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _beamflag_type;
  _beamflag_type beamflag;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _twowayTravelTime_type;
  _twowayTravelTime_type twowayTravelTime;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _txDelay_type;
  ...
  _intensity_type intensity;
   ...
   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _angleAlongTrack_type;
  _angleAlongTrack_type angleAlongTrack;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _angleAcrossTrack_type;
  _angleAcrossTrack_type angleAcrossTrack;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _beamwidthAlongTrack_type;
  _beamwidthAlongTrack_type beamwidthAlongTrack;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _beamwidthAcrossTrack_type;
