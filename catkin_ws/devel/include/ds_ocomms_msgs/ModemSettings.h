...
struct ModemSettings_
{
  ...
  _ds_header_type ds_header;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _ip_addr_type;
  ...
  _netmask_type netmask;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _brdcst_type;
  _brdcst_type brdcst;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _dfltgw_type;
  _dfltgw_type dfltgw;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _dfltip_type;
  _dfltip_type dfltip;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _dflmac_type;
  _dflmac_type dflmac;

   typedef double _dflprt_type;
  _dflprt_type dflprt;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _laripa_type;
  _laripa_type laripa;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _larmac_type;
  _larmac_type larmac;

   typedef double _larprt_type;
  _larprt_type larprt;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _lfpipa_type;
  _lfpipa_type lfpipa;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _lfpmac_type;
  _lfpmac_type lfpmac;

   typedef double _lfpprt_type;
  _lfpprt_type lfpprt;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _remipa_type;
  _remipa_type remipa;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _raripa_type;
  _raripa_type raripa;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _rarmac_type;
  _rarmac_type rarmac;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _rsubnt_type;
  _rsubnt_type rsubnt;

   typedef uint16_t _brdgen_type;
  _brdgen_type brdgen;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _brdgip_type;
  _brdgip_type brdgip;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _guiipa_type;
  _guiipa_type guiipa;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _fpg3vr_type;
  _fpg3vr_type fpg3vr;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _fpg6vr_type;
  _fpg6vr_type fpg6vr;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _softvr_type;
  _softvr_type softvr;
...
struct Printer< ::ds_ocomms_msgs::ModemSettings_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ds_ocomms_msgs::ModemSettings_<ContainerAllocator>& v)
  {
    ...
    s << indent << "ip_addr: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.ip_addr);
    s << indent << "netmask: ";
    ...
    s << indent << "brdcst: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.brdcst);
    s << indent << "dfltgw: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.dfltgw);
    s << indent << "dfltip: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.dfltip);
    s << indent << "dflmac: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.dflmac);
    s << indent << "dflprt: ";
    Printer<double>::stream(s, indent + "  ", v.dflprt);
    s << indent << "laripa: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.laripa);
    s << indent << "larmac: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.larmac);
    s << indent << "larprt: ";
    Printer<double>::stream(s, indent + "  ", v.larprt);
    s << indent << "lfpipa: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.lfpipa);
    s << indent << "lfpmac: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.lfpmac);
    s << indent << "lfpprt: ";
    Printer<double>::stream(s, indent + "  ", v.lfpprt);
    s << indent << "remipa: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.remipa);
    s << indent << "raripa: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.raripa);
    s << indent << "rarmac: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.rarmac);
    s << indent << "rsubnt: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.rsubnt);
    s << indent << "brdgen: ";
    Printer<uint16_t>::stream(s, indent + "  ", v.brdgen);
    s << indent << "brdgip: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.brdgip);
    s << indent << "guiipa: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.guiipa);
    s << indent << "fpg3vr: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.fpg3vr);
    s << indent << "fpg6vr: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.fpg6vr);
    s << indent << "softvr: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.softvr);
    s << indent << "reboot: ";
