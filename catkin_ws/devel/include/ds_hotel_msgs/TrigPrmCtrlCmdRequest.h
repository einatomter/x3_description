...
struct TrigPrmCtrlCmdRequest_
{
  ...
  _command_type command;
   ...
   typedef std::vector< ::ds_hotel_msgs::TriggerChannelConfig_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_hotel_msgs::TriggerChannelConfig_<ContainerAllocator> >::other >  _channels_to_change_type;
  _channels_to_change_type channels_to_change;

   typedef std::vector< ::ds_core_msgs::KeyString_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::KeyString_<ContainerAllocator> >::other >  _global_params_to_change_type;
