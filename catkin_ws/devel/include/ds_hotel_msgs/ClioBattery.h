...
struct ClioBattery_
{
  ...
  _moduleStatus_type moduleStatus;
   ...
   typedef std::vector< ::ds_hotel_msgs::ClioBatteryPack_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_hotel_msgs::ClioBatteryPack_<ContainerAllocator> >::other >  _packs_type;
  _packs_type packs;
