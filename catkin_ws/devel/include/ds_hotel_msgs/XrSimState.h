...
struct XrSimState_
{
  ...
  _idx_type idx;
   ...
   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _dcams_actual_type;
  _dcams_actual_type dcams_actual;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _wires_actual_type;
  _wires_actual_type wires_actual;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _dcams_cmds_type;
  _dcams_cmds_type dcams_cmds;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _wires_cmds_type;
  _wires_cmds_type wires_cmds;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _motor_secs_type;
  _motor_secs_type motor_secs;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _burnwire_secs_type;
  ...
  _acoustic_code_type acoustic_code;
   ...
   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _dcam_open_pct_type;
  _dcam_open_pct_type dcam_open_pct;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _wire_burn_pct_type;
