...
struct PwrSwitchDeviceStatus_
{
  ...
  _ds_header_type ds_header;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _card_name_type;
  ...
  _device_name_type device_name;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _device_state_type;
...
struct Printer< ::ds_hotel_msgs::PwrSwitchDeviceStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ds_hotel_msgs::PwrSwitchDeviceStatus_<ContainerAllocator>& v)
  {
    ...
    s << indent << "card_name: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.card_name);
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.device_state);
  }
};
