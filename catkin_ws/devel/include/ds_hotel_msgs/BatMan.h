...
struct BatMan_
{
  ...
  _percentFull_type percentFull;
   ...
   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _moduleVolt_type;
  _moduleVolt_type moduleVolt;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _moduleAh_type;
  _moduleAh_type moduleAh;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _moduleCapacity_type;
  _moduleCapacity_type moduleCapacity;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _modulePercent_type;
  _modulePercent_type modulePercent;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _moduleDischarging_type;
  _moduleDischarging_type moduleDischarging;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _moduleCharging_type;
