...
struct QueueDefinition_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _background_data_type;
  _background_data_type background_data;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _send_once_topics_type;
  _send_once_topics_type send_once_topics;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _queue_topics_type;
  _queue_topics_type queue_topics;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _queue_periods_type;
