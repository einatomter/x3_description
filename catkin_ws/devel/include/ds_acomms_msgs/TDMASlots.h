...
struct TDMASlots_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _starts_type;
  _starts_type starts;
  ...
  _durations_type durations;
   ...
   typedef std::vector<int8_t, typename ContainerAllocator::template rebind<int8_t>::other >  _rates_type;
  _rates_type rates;
