...
struct Vtg_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _talker_type;
  _talker_type talker;
...
struct Printer< ::ds_nmea_msgs::Vtg_<ContainerAllocator> >
{
  ...
  {
    s << indent << "talker: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.talker);
