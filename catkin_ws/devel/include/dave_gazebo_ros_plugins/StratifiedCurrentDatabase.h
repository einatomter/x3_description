...
struct StratifiedCurrentDatabase_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _depths_type;
  _depths_type depths;
  ...
  _velocities_type velocities;
   ...
   typedef std::vector<int16_t, typename ContainerAllocator::template rebind<int16_t>::other >  _timeGMTYear_type;
  _timeGMTYear_type timeGMTYear;

   typedef std::vector<int16_t, typename ContainerAllocator::template rebind<int16_t>::other >  _timeGMTMonth_type;
  _timeGMTMonth_type timeGMTMonth;

   typedef std::vector<int16_t, typename ContainerAllocator::template rebind<int16_t>::other >  _timeGMTDay_type;
  _timeGMTDay_type timeGMTDay;

   typedef std::vector<int16_t, typename ContainerAllocator::template rebind<int16_t>::other >  _timeGMTHour_type;
  _timeGMTHour_type timeGMTHour;

   typedef std::vector<int16_t, typename ContainerAllocator::template rebind<int16_t>::other >  _timeGMTMinute_type;
  _timeGMTMinute_type timeGMTMinute;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _tideVelocities_type;
