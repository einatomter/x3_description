...
struct PhinsStandard_
{
  ...
  _time_pos_type time_pos;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _algorithm_status_lsb_type;
  _algorithm_status_lsb_type algorithm_status_lsb;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _algorithm_status_msb_type;
  _algorithm_status_msb_type algorithm_status_msb;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _system_status_lsb_type;
  _system_status_lsb_type system_status_lsb;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _system_status_msb_type;
  _system_status_msb_type system_status_msb;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _user_status_type;
...
struct Printer< ::ds_sensor_msgs::PhinsStandard_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ds_sensor_msgs::PhinsStandard_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.algorithm_status_lsb);
    s << indent << "algorithm_status_msb: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.algorithm_status_msb);
    s << indent << "system_status_lsb: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.system_status_lsb);
    s << indent << "system_status_msb: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.system_status_msb);
    s << indent << "user_status: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.user_status);
  }
};
