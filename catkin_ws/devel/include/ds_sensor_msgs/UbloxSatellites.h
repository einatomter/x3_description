...
struct UbloxSatellites_
{
  ...
  _time_of_week_type time_of_week;
   ...
   typedef std::vector< ::ds_sensor_msgs::UbloxSatellite_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_sensor_msgs::UbloxSatellite_<ContainerAllocator> >::other >  _sats_type;
  _sats_type sats;
