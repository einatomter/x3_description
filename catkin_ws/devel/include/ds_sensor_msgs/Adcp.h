...
struct Adcp_
{
  ...
  _beam_unit_vec_type beam_unit_vec;
   ...
   typedef std::vector< ::ds_sensor_msgs::WaterCurrentProfile_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_sensor_msgs::WaterCurrentProfile_<ContainerAllocator> >::other >  _vel_bin_beams_type;
