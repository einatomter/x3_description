...
struct ParamUpdate_
{
  ...
  _source_type source;
   ...
   typedef std::vector< ::ds_core_msgs::KeyBool_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::KeyBool_<ContainerAllocator> >::other >  _bools_type;
  _bools_type bools;

   typedef std::vector< ::ds_core_msgs::KeyInt_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::KeyInt_<ContainerAllocator> >::other >  _ints_type;
  _ints_type ints;

   typedef std::vector< ::ds_core_msgs::KeyFloat_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::KeyFloat_<ContainerAllocator> >::other >  _floats_type;
  _floats_type floats;

   typedef std::vector< ::ds_core_msgs::KeyDouble_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::KeyDouble_<ContainerAllocator> >::other >  _doubles_type;
  _doubles_type doubles;

   typedef std::vector< ::ds_core_msgs::KeyString_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::KeyString_<ContainerAllocator> >::other >  _strings_type;
