...
struct CountdownMonitor_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::ds_core_msgs::Countdown_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::Countdown_<ContainerAllocator> >::other >  _nodes_type;
  _nodes_type nodes;
