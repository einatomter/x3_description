...
struct IoSMcommandRequest_
{
  ...
  _iosm_command_type iosm_command;
   ...
   typedef std::vector< ::ds_core_msgs::IoCommand_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::IoCommand_<ContainerAllocator> >::other >  _commands_type;
