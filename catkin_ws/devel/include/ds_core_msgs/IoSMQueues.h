...
struct IoSMQueues_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::ds_core_msgs::IoCommand_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::IoCommand_<ContainerAllocator> >::other >  _regular_type;
  _regular_type regular;

   typedef std::vector< ::ds_core_msgs::IoCommand_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::IoCommand_<ContainerAllocator> >::other >  _preempt_type;
  _preempt_type preempt;

   typedef std::vector< ::ds_core_msgs::IoCommand_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ds_core_msgs::IoCommand_<ContainerAllocator> >::other >  _shutdown_type;
